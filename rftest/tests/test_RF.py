...
#class TestOVS(Tests_RF):
#class TestOVS(RF_Tests):
class TestOVS():

    logger = logging.getLogger('Entering TestOVS')
...
if __name__ == '__main__':
    ...
    tests = ['lxc','ovs']
    server = RF_Run_Tests(args.mongoport, args.controllerport1, args.controllerport2, args.lxcname,tests)
